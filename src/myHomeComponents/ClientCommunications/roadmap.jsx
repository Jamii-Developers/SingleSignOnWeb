    ...
    const [roadmapItems, setRoadmapItems] = useState([
        {
            ...
            items: [
                ...
                { id: 4, text: 'Ability to block users', completed: false, completionDate: '2025-05-10' },
                { id: 5, text: 'Ability to unfriend users', completed: false, completionDate: '2025-05-10' },
                { id: 6, text: 'Ability to unfollow users', completed: false, completionDate: '2025-05-10' },
                ...
                { id: 12, text: 'Ability to view blocked users', completed: false, completionDate: '2025-05-10' },
            ]
        },
        {
